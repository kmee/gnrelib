...
#   ('-a', '')
#   ('-o', 'gnrelib/v1_12/consulta_config_uf.py')
#
# Command line arguments:
#   schemas/v1.12/consulta_config_uf_v1.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS -a -o "gnrelib/v1_12/consulta_config_uf.py" schemas/v1.12/consulta_config_uf_v1.00.xsd
#
...
class TConsultaConfigUf(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ambiente=None, uf=None, receita=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TConsultaConfigUf)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TConsultaConfigUf.subclass:
            return TConsultaConfigUf.subclass(*args_, **kwargs_)
        else:
            return TConsultaConfigUf(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            self.receita is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='TConsultaConfigUf', namespacedef_='xmlns:tns="http://www.gnre.pe.gov.br"', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TConsultaConfigUf')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TConsultaConfigUf', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TConsultaConfigUf'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='TConsultaConfigUf', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.receita is not None:
            self.receita.export(outfile, level, namespace_, name_='receita', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class receita(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, courier=None, valueOf_=None):
        self.original_tagname_ = None
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='receita'):
        if self.courier is not None and 'courier' not in already_processed:
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'TConsultaConfigUf'
        rootClass = TConsultaConfigUf
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from consulta_config_uf import *\n\n')
        sys.stdout.write('import consulta_config_uf as model_\n\n')
