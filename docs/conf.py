# -*- coding: utf-8 -*-
#
# gnrelib documentation build configuration file, created by
...
latex_documents = [
  ('index', 'gnrelib.tex', u'gnrelib Documentation',
...
man_pages = [
    ('index', 'gnrelib', u'gnrelib Documentation',
     [u'Dave Kuhlman'], 1)
]
